...
const celebPosterOptions = require('./options/celeb-poster-options.js')
...
try {
  ...
  let pinputfile = './output/parsedCelebrities/pcelebs00.json';
  ...
  console.info(`there are ${queryStrs.length} celebs to query portraits for`);
  var ms = new MediaScraper(queryStrs, celebPosterOptions);
